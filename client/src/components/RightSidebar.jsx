...
const RightSidebar = () => {
    ...
    return selectedUser && (
        <div className={`bg-[8184B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? 'max-md:hidden' : ''} `}>
            <div className='flex flex-col items-center pt-16 gap-2 text-xs font-light mx-auto'>
                <img src={selectedUser?.profilePic || assets.avatar_icon} alt="" className='w-10 aspect-[1/1] rounded-full' />
